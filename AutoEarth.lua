...
workspace.FriendlyNPCs["Young Man"]
)
wait (0.5)
local ChatAdvance =
game:GetService("Players").LocalPlayer.Backpack.ServerTraits.ChatAdvance
...
local ChatStart = game:GetService("Players").LocalPlayer.Backpack.ServerTraits.ChatStart
ChatStart:FireServer(
workspace.FriendlyNPCs["Suitcase"]
)
wait (0.5)
local ChatAdvance =
game:GetService("Players").LocalPlayer.Backpack.ServerTraits.ChatAdvance
...
wait(.5)
game:GetService("Players").LocalPlayer.Backpack.ServerTraits.ChatAdvance:FireServer({[1] = "DRINK"})
